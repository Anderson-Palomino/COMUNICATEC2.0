...
<head>
    ...
    <title>COMUNICATEC&reg; - iPhone 15 Pro</title>
...
<body>
    ...
    $sql = "select id, nombre, tipo, precio, stock, cantVendidos, img, urlPHP from producto where tipo like 'ios' and nombre like 'iPhone 15 Pro';";
    ...
    <div class="containerCarac">
        <section class="especificaciones">
            ...
            <ul class="animate__animated animate__fadeInRight">
                ...
                <li class="animate__animated animate__fadeIn">Batería: 23 horas de reproducción de vídeo</li>
        ...
        <section class="especificaciones">
            ...
            <hr>
            <iframe src="https://www.youtube.com/embed/xqyUdNxWazA?si=4eYih9mmJQsSn9MZ" frameborder="0" allowfullscreen class="animate__animated animate__fadeInUp"></iframe>
        </section>
