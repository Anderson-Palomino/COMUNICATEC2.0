...
<head>
    ...
    <title>COMUNICATEC&reg; - iPhone 13 Pro Max</title>
...
<body>
    ...
    $sql = "select id, nombre, tipo, precio, stock, cantVendidos, img, urlPHP from producto where tipo like 'ios' and nombre like 'iPhone 13 Pro Max';";
    ...
    <div class="containerCarac">
        <section class="especificaciones">
            ...
            <ul class="animate__animated animate__fadeInRight">
                <li class="animate__animated animate__fadeIn">Pantalla: 6.7" pulgadas</li>
                ...
                <li class="animate__animated animate__fadeIn">Cámara: Cámara Principal de 12+12+12MP y Cámara Frontal de 12MP</li>
                <li class="animate__animated animate__fadeIn">Sistema Operativo: iOS 15</li>
                <li class="animate__animated animate__fadeIn">Conectividad: 2G, 3G, 4G LTE, 5G, NFC, GPS, WiFi, EDGE, Bluetooth y Acceso a web</li>
                <li class="animate__animated animate__fadeIn">RAM: 6GB</li>
                <li class="animate__animated animate__fadeIn">Colores: Azul</li>
            </ul>
        </section>
        ...
        <section class="especificaciones">
            ...
            <hr>
            <iframe class="animate__animated animate__fadeInUp" src="https://www.youtube.com/embed/9Wsux4Bggm8?si=tdWqh15t13hdGHMs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </section>
