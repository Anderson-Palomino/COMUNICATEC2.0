...
<head>
    ...
    <title>COMUNICATEC&reg; - iPhone 13</title>
...
<body>
    ...
    $sql = "select id, nombre, tipo, precio, stock, cantVendidos, img, urlPHP from producto where tipo like 'ios' and nombre like 'iPhone 13';";
    ...
    <div class="containerCarac">
        <section class="especificaciones">
            ...
            <ul class="animate__animated animate__fadeInRight">
                <li class="animate__animated animate__fadeIn">Pantalla: 6.1" pulgadas 1170 x 2532 pixeles</li>
                ...
                <li class="animate__animated animate__fadeIn">Conectividad: 2G, 3G, 4G, 5G, NFC, GPS, WiFi, GPRS, EDGE, Bluetooth, Acceso a web, Módem Integrado y A-GPS</li>
        ...
        <section class="especificaciones">
            ...
            <hr>
            <iframe class="animate__animated animate__fadeInUp" src="https://www.youtube.com/embed/KL_sDefZmcU?si=7LE2U7yoAGC_B_0Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </section>
