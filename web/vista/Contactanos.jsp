                ...
                <div class="info">
                    <article id="bloque">
                        ...
                        <ul class="redesSociales"> <!---REDES SOCIALES--->
                            <li><i class="fab fa-facebook"></i><b> Facebook:</b><a href="#"><br>facebook.com/ComunicaTEC</a></li><br />
                            <li><i class="fab fa-instagram"></i><b> Instagram:</b><a href="#"><br/>instagram.com/ComunicaTEC</a></li><br />
                            <li><i class="fab fa-tiktok"></i><b> Tiktok:</b><a href="#"><br />tiktok.com/ComunicaTEC</a></li><br />
                        </ul>
                    </article>
                </div>
