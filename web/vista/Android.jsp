...
<html>
    ...
    <body>
        ...
        <c:forEach var="an" items="${android}">
            <div class="card" style="width: 18rem;">
                <img src="${pageContext.request.contextPath}/img/${an.getImagen()}" class="card-img-top" alt="android">
                <div class="card-body">
                    <h5 class="card-title">${an.getNombre()}</h5>
                    <p class="card-text">S/.${an.getPrecio()}</p>
