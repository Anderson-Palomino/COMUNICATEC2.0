...
<html>
    <head>
        ...
        <link href="<%=request.getContextPath()%>/css/nosotrosCSS.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        <h1>CELULARES</h1>
        <c:forEach var="o" items="${android}">
            <div class="card" style="width: 18rem;">
                <img src="${pageContext.request.contextPath}/img/${p.getImagen()}" class="card-img-top" alt="android">
                <div class="card-body">
