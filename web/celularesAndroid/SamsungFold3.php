...
<head>
    ...
    <title>COMUNICATEC&reg; - Samsung Galaxy Z Fold 3</title>
...
<body>
    ...
    $sql = "select id, nombre, tipo, precio, stock, cantVendidos, img, urlPHP from producto where tipo like 'android' and nombre like 'Samsung Galaxy Z Fold 3';";
    ...
    <div class="containerCarac">
        <section class="especificaciones">
            ...
            <ul class="animate__animated animate__fadeInRight">
                <li class="animate__animated animate__fadeIn">Pantalla: 6,2 pulgadas, 120Hz, 2.268x832 pixeles</li>
                <li class="animate__animated animate__fadeIn">Procesador: Snapdragon 888 (2,84Ghz)</li>
                <li class="animate__animated animate__fadeIn">Almacenamiento: 256 GB, 512 GB</li>
                <li class="animate__animated animate__fadeIn">Cámara: 12 MP + 12 MP (gran angular) + 12 MP (telefoto)</li>
                <li class="animate__animated animate__fadeIn">Batería: 4.400 mAh (25W)</li>
                ...
                <li class="animate__animated animate__fadeIn">Colores: Negro</li>
            </ul>
        </section>
        ...
        <section class="especificaciones">
            ...
            <hr>
            <iframe src="https://www.youtube.com/embed/EzH2BZ-STrE?si=fyDPhq8ozWN0GOg8" frameborder="0" allowfullscreen class="animate__animated animate__fadeInUp"></iframe>
        </section>
