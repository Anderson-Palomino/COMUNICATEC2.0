...
<head>
    ...
    <title>COMUNICATEC&reg; - Redmi Note 12</title>
...
<body>
    ...
    $sql = "select id, nombre, tipo, precio, stock, cantVendidos, img, urlPHP from producto where tipo like 'android' and nombre like 'Redmi Note 12';";
    ...
    <div class="containerCarac">
        <section class="especificaciones">
            ...
            <ul class="animate__animated animate__fadeInRight">
                <li class="animate__animated animate__fadeIn">Pantalla: 6.67" pulgadas Amoled FHD+ (2400x1080)</li>
                <li class="animate__animated animate__fadeIn">Procesador: Qualcomm Snapdragon 685</li>
                <li class="animate__animated animate__fadeIn">Almacenamiento: 128GB</li>
                <li class="animate__animated animate__fadeIn">Cámara: Cámara Principal de 50+8+2MP y Cámara Frontal de 13MP</li>
                <li class="animate__animated animate__fadeIn">Batería: 5000 mAh 33W</li>
                <li class="animate__animated animate__fadeIn">Sistema Operativo: Android 13</li>
                <li class="animate__animated animate__fadeIn">Conectividad: 2G, 3G, 4G LTE, GPS, WiFi, Hotspot/módem, GPRS, EDGE, Bluetooth, Acceso a web, Módem Integrado y A-GPS</li>
                <li class="animate__animated animate__fadeIn">RAM: 4GB</li>
                <li class="animate__animated animate__fadeIn">Color: Azul Hielo</li>
            </ul>
        </section>
        ...
        <section class="especificaciones">
            ...
            <hr>
            <iframe class="animate__animated animate__fadeInUp" src="https://www.youtube.com/embed/ks6jXex8dxU?si=oz4W48xBvQv7VOcE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </section>
