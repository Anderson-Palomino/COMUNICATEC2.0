...
<head>
    ...
    <title>COMUNICATEC&reg; - Samsung Galaxy S21</title>
...
<body>
    ...
    $sql = "select id, nombre, tipo, precio, stock, cantVendidos, img, urlPHP from producto where tipo like 'android' and nombre like 'Samsung Galaxy S21';";
    ...
    <div class="containerCarac">
        <section class="especificaciones">
            ...
            <ul class="animate__animated animate__fadeInRight">
                <li class="animate__animated animate__fadeIn">Pantalla: 6.2 pulgadas FHD AMOLED 2400 x 1080</li>
                <li class="animate__animated animate__fadeIn">Procesador: Qualcomm</li>
                <li class="animate__animated animate__fadeIn">Almacenamiento: 256GB</li>
                <li class="animate__animated animate__fadeIn">Cámara: Cámara posterior de 64MP y Cámara Frontal de 10 MP</li>
                <li class="animate__animated animate__fadeIn">Batería: 4000 mAh</li>
                <li class="animate__animated animate__fadeIn">Sistema Operativo: Android 11</li>
                <li class="animate__animated animate__fadeIn">Conectividad: 2G GSM, 3G WCDMA, 4G TDD-LTE, FDD-LTE y 5G</li>
        ...
        <section class="especificaciones">
            ...
            <hr>
            <iframe class="animate__animated animate__fadeInUp" src="https://www.youtube.com/embed/dnaVkyYnHB0?si=Uv-fvaNp-vix3Gns" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </section>
