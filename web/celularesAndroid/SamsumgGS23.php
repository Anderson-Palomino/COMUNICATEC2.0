...
<head>
    ...
    <title>COMUNICATEC&reg; - Samsung Galaxy S23</title>
...
<body>
    ...
    $sql = "select id, nombre, tipo, precio, stock, cantVendidos, img, urlPHP from producto where tipo like 'android' and nombre like 'Samsung Galaxy S23';";
    ...
    <div class="containerCarac">
        <section class="especificaciones">
            ...
            <ul class="animate__animated animate__fadeInRight">
                <li class="animate__animated animate__fadeIn">Pantalla: 6,1″ pulgadas Dynamic AMOLED 2X</li>
                <li class="animate__animated animate__fadeIn">Procesador: Snapdragon 8 Gen 2</li>
                <li class="animate__animated animate__fadeIn">Almacenamiento: 128 GB, 256 GB, 512 GB</li>
                <li class="animate__animated animate__fadeIn">Cámara: Triple, 50 MP + 12 MP + 10 MP</li>
                <li class="animate__animated animate__fadeIn">Batería: 3.900 mAh</li>
                ...
                <li class="animate__animated animate__fadeIn">Colores: negro, Blanco y Azul</li>
            </ul>
        </section>
        ...
        <section class="especificaciones">
            ...
            <hr>
            <iframe src="https://www.youtube.com/embed/G7z9L52oFEs?si=piq5fDZDIbRFd6BH" frameborder="0" allowfullscreen class="animate__animated animate__fadeInUp"></iframe>
        </section>
